...
class Spider(Spider):
    sources = {
        ...
        's4': {'name': '📺天涯', 'api': 'https://tyyszy.com/api.php/provide/vod'},
        's5': {'name': '📺暴风', 'api': 'https://bfzyapi.com/api.php/provide/vod'},
        's6': {'name': '⚡索尼闪电', 'api': 'https://xsd.sdzyapi.com/api.php/provide/vod'},
        's7': {'name': '📺索尼', 'api': 'https://suoniapi.com/api.php/provide/vod'},
        's8': {'name': '📺茅台', 'api': 'https://caiji.maotaizy.cc/api.php/provide/vod'},
        's9': {'name': '🐯虎牙', 'api': 'https://www.huyaapi.com/api.php/provide/vod'},
        's10': {'name': '📺豆瓣', 'api': 'https://dbzy.tv/api.php/provide/vod'},
        's11': {'name': '📺豪华', 'api': 'https://hhzyapi.com/api.php/provide/vod'},

        's12': {'name': '📺无尽', 'api': 'https://api.wujinapi.cc/api.php/provide/vod'},
        's13': {'name': '🌕光速', 'api': 'https://api.guangsuapi.com/api.php/provide/vod'},
        's14': {'name': '📺新浪', 'api': 'https://api.xinlangapi.com/xinlangapi.php/provide/vod'},
        's15': {'name': '📺最大', 'api': 'https://api.zuidapi.com/api.php/provide/vod'},
        's16': {'name': '🌸樱花', 'api': 'https://m3u8.apiyhzy.com/api.php/provide/vod'},
        's17': {'name': '🐮牛牛', 'api': 'https://api.niuniuzy.me/api.php/provide/vod'},
        's18': {'name': '☁️百度云', 'api': 'https://api.apibdzy.com/api.php/provide/vod'},
        's19': {'name': '🏎速播', 'api': 'https://subocaiji.com/api.php/provide/vod'},
        's20': {'name': '⚡闪电', 'api': 'https://sdzyapi.com/api.php/provide/vod'},
        's21': {'name': '👑非凡', 'api': 'https://cj.ffzyapi.com/api.php/provide/vod'},
        's22': {'name': '🍃飘零', 'api': 'https://p2100.net/api.php/provide/vod'},
        's23': {'name': '📺魔都', 'api': 'https://www.mdzyapi.com/api.php/provide/vod'},
    }
